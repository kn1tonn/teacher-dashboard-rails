# -*- encoding: utf-8 -*-
# stub: actiontext 8.1.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/rails/rails/issues", "changelog_uri" => "https://github.com/rails/rails/blob/v8.1.0/actiontext/CHANGELOG.md", "documentation_uri" => "https://api.rubyonrails.org/v8.1.0/", "mailing_list_uri" => "https://discuss.rubyonrails.org/c/rubyonrails-talk", "rubygems_mfa_required" => "true", "source_code_uri" => "https://github.com/rails/rails/tree/v8.1.0/actiontext" } if s.respond_to? :metadata=
